...
public class exercises33 {
    ...
    private static double[] getArea(double[][] points, double[] intersectPoint) {
    ...
    private static double[] getIntersectPoint(double[][] points) {
    ...
    private static double[][] createPoints() {
